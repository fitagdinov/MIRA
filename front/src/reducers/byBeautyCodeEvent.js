const SET_BY_BEAUTY_EVENT = "SET_BY_BEAUTY_EVENT"
...
// редюсер мероприятий 
export default function byBeautyEventReducer(state = defaultState, action) {
    switch (action.type) {
        case SET_BY_BEAUTY_EVENT:
            return {
                ...state,
...
export const setByBeautyEvent = (event) => ({type:SET_BY_BEAUTY_EVENT, server_answer:event})
