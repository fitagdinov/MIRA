...
class SmallEventCardDescription(Schema):
    ...
    @classmethod
    def constructor(cls, sys_event_id, extend_event_id, short_event_name, description_event, beauty_code_event,
                    level1_event, level2_event, level3_event):
        return {
